...
This package provides a convenient way to identify endmembers for the purpose
of provenance analysis, using principle component analysis [@A.D.G+24], and to
